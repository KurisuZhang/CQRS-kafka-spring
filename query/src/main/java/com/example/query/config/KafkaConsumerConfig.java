...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ProductEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.example.query.model.ProductEvent");
        // Trust all packages
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.query.model");
